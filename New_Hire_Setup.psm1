...
function Install-Software{
    ...
    if ($PSBoundParameters.ContainsKey('Mitel')){
            Start-Process -Wait -FilePath .\Software\MitelConnect.exe -ArgumentList "/S" -PassThrur
        }
...
function Change-Settings{
    ...
    Import-StartLayout -Path #Path to layout
    powercfg /import <#path to scheme#>
    


}

Export-ModuleMember -Function Join-Computer, Install-Software, Change-Settings